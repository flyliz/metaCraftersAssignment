...
My code is found in the file healourcult.sol

blockchain token named HOC
...
create a new file called healourcult.sol under the contracts folder in the remix ide explorer
...
## Authors
fly_liz with help from metacrafters
